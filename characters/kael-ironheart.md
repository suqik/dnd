# Kael Ironheart 个人角色卡 / Character Sheet
...
使用标准数组；士兵背景提供力量 +2、体质 +1，人类不额外增加属性。
...
战士 Fighter 熟练豁免：力量 Strength、体质 Constitution。

| 豁免 | 加值 |
|---|---:|
| 力量 Strength (STR) | +5 |
| 敏捷 Dexterity (DEX) | +2 |
| 体质 Constitution (CON) | +4 |
| 智力 Intelligence (INT) | +0 |
| 感知 Wisdom (WIS) | +1 |
| 魅力 Charisma (CHA) | -1 |

## 技能、语言与熟练项 / Skills, Languages, and Proficiencies
...
| 奥秘 Arcana | 智力 INT | 否 No | +0 |
| 历史 History | 智力 INT | 否 No | +0 |
| 调查 Investigation | 智力 INT | 否 No | +0 |
| 自然 Nature | 智力 INT | 否 No | +0 |
| 宗教 Religion | 智力 INT | 否 No | +0 |
