...
| 等级 Level | 3 |
| 总经验 / 升级所需总经验 Total XP / Total XP Needed | 1249 / 2700 |
...
| 法术储存戒指 Spell-Storing Ring | 1 枚 | 打败马特委托所称的黑暗势力首领后获得；可储存 1 个 1 环法术，每次长休可使用 1 次。DM 奖励允许选取任意 1 环法师法术，当前储存防护善恶 Protection from Evil and Good；释放时需专注，对异怪、天界生物、元素、精类、邪魔和亡灵提供防护 |
...
| 金币 GP | 2 | 当前持有 |
| 欠蛋蛋与 Kael 的借款 Debt | 66 GP | 购买珍珠时向蛋蛋借入 33 GP、向 Kael 借入 33 GP；偿还安排尚未记录 |
